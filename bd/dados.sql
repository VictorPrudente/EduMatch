...
INSERT INTO QUESTAO (id_questao, pergunta, pontos, opcao_correta, dificuldade, trilha)
...
E) Uma demonstração de coragem', 3, 'A', 2, 1);
...
E) Chorar por algo perdido', 5, 'D', 3, 1);
...
e) Gostamos de pizza, com bastante queijo.', 5, 'B', 3, 1);
...
E) Não leva em consideração o sentimento dos colegas ', 3, 'C', 2, 3);
...
E) Inteligência emocional', 3, 'B', 2, 3);
...
D) Saber dizer “não”
E) Fazer qualquer coisa que é solicitado ', 3, 'B', 2, 3);
...
E) Somente dar feedback positivo', 3, 'B', 2, 3);
...
E) Priorizar somente grandes projetos', 5, 'C', 3, 3);
...
E) Diminuindo a empatia', 5, 'C', 3, 3);

-- Insert Contatos

-- enderecos usuarios
INSERT INTO ENDERECO (id_endereco, logradouro, numero, complemento, cep, cidade, estado, pais, id_usuario, tipo_endereco)
VALUES (SEQ_ENDERECO.NEXTVAL,'Rua Presidente Vargas', 123, 'Chácara', '12345678', 'Porto Alegre', 'RS', 'Brasil', 1, 0);

INSERT INTO ENDERECO (id_endereco, logradouro, numero, complemento, cep, cidade, estado, pais, id_usuario, tipo_endereco)
VALUES (SEQ_ENDERECO.NEXTVAL,'Rua São Pedro', 456, 'Bloco a', '23456789', 'Rio de Janeiro', 'RJ', 'Brasil', 1, 0);
